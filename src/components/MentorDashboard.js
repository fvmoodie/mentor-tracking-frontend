...
const MentorDashboard = () => {
  ...
  useEffect(() => {
    // Retrieve mentor's actual name from local storage
    const storedName = localStorage.getItem("mentorName") || "Mentor";
    ...
    <div className="container">
      ...
      <div className="top-row">
        <div className="top-left">
          ...
          <span className="welcome-text">Welcome, {mentorName} Dashboard</span>
        </div>
        <div className="top-right">
          <div className="top-controls">
            ...
            <Suspense fallback={<div>Loading...</div>}>
              ...
              <FaSignOutAlt className="icon logout-icon large-icon" title="Log Out" onClick={handleLogout} />
            </Suspense>
          </div>
      ...
      <div className="middle-row">
        {/* Column 1: Mentor Features with Submenus */}
        <div className="column features-column">
          {[
            { title: "👤 My Assigned Individuals", subItems: ["View individual profiles", "Anniversary goal updates", "Region", "Status"] },
            { title: "📊 Objective & Goal Tracking", subItems: ["Morning progress", "Afternoon progress", "Evening progress", "Community Activities", "Goal Activities"] },
            { title: "📅 Task Reminders", subItems: ["View upcoming tasks", "View overdue tasks", "Mark tasks as completed"] },
            { title: "🏥 Medical & Emergency", subItems: ["Track medical visits", "Track emergency drills", "View doctor’s notes", "Health records"] },
            { title: "📄 Reports & Submissions", subItems: ["Weekly", "Monthly", "Incident"] },
            { title: "📝 Action Plans", subItems: ["View/update action plans for individuals"] },
          ].map((menu, index) => (
            <div
              key={index}
              className="menu-item"
